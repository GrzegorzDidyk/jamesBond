{
    const actorsButton = document.querySelector(".sectionActors__button");

    const onClickChangeActor = () => {
        const actorsParagraph = document.querySelector(".sectionActors__paragraphName");
        const actorsGallery = document.querySelector(".sectionActors__galery");

        switch (actorsButton.innerText) {
            case "Pierwszy Aktor":
    ...
    const init = () => {
        actorsButton.addEventListener("click", onClickChangeActor);
    };
    init();
